 ...
 */
import { listIngredients as api_menu_list_ingredients_listIngredients } from "~backend/menu/list_ingredients";
import { listPastaTypes as api_menu_list_pasta_types_listPastaTypes } from "~backend/menu/list_pasta_types";
import { listSauces as api_menu_list_sauces_listSauces } from "~backend/menu/list_sauces";
...
export namespace menu {
    ...
    export class ServiceClient {
         ...
         */
        public async listIngredients(params: RequestType<typeof api_menu_list_ingredients_listIngredients>): Promise<ResponseType<typeof api_menu_list_ingredients_listIngredients>> {
            ...
            const resp = await this.baseClient.callTypedAPI(`/ingredients`, {query, method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_menu_list_ingredients_listIngredients>
        }

        /**
         * Retrieves all available pasta types.
         */
        public async listPastaTypes(): Promise<ResponseType<typeof api_menu_list_pasta_types_listPastaTypes>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/pasta-types`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_menu_list_pasta_types_listPastaTypes>
        }

        /**
         * Retrieves all available sauces.
         */
        public async listSauces(): Promise<ResponseType<typeof api_menu_list_sauces_listSauces>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/sauces`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_menu_list_sauces_listSauces>
        }
    }
}
 ...
 * Import the endpoint handlers to derive the types for the client.
 */
import { createOrder as api_orders_create_order_createOrder } from "~backend/orders/create_order";
...
export namespace orders {
    ...
    export class ServiceClient {
         ...
         */
        public async createOrder(params: RequestType<typeof api_orders_create_order_createOrder>): Promise<ResponseType<typeof api_orders_create_order_createOrder>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/orders`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_orders_create_order_createOrder>
        }

        /**
         * Retrieves a specific order with all its items and ingredients.
         */
        public async getOrder(params: { id: number }): Promise<ResponseType<typeof api_orders_get_order_getOrder>> {
            // Now make the actual call to the API
