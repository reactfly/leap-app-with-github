...
```bash
git remote add encore encore://integrate-leap-app-with-github-s2x2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/integrate-leap-app-with-github-s2x2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/integrate-leap-app-with-github-s2x2/settings/integrations/github)
